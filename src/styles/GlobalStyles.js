...
// Add the font imports directly in the GlobalStyles to make sure they are always loaded
...
root:
  body {
    font-family: ${(props) =>
      ...
      "sans-serif"}; /* Sjekk at theme og fonts eksisterer */
  ...
  h1, h2, h3 {
    font-family: ${(props) =>
      ...
      "serif"}; /* Sjekk at theme og fonts eksisterer */
  }
